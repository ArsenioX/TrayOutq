...
@section('content')
    <div class="container py-5">
        <h1 class="text-center fw-bold mb-5 text-dark">💳 Checkout</h1>

        @if ($items->count() > 0)
            {{-- Ringkasan Keranjang --}}
            <div class="card shadow mb-4">
                <div class="card-body">
                    <h5 class="fw-semibold mb-4 d-flex align-items-center gap-2">📦 Ringkasan Pesanan</h5>
                        ...
                        @foreach ($items as $item)
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <small class="text-muted d-block">Harga: Rp
                                        {{ number_format($item->produk->harga, 0, ',', '.') }}</small>
                                    <small class="text-muted d-block">Jumlah: {{ $item->jumlah }}</small>
                                    <small
            ...
            <form method="POST" action="{{ route('user.checkout.process') }}" class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="bg-light border rounded p-3 mb-3">
                        <p class="fw-medium mb-1">Silakan transfer ke nomor berikut:</p>
